...
3. Create release via `gh release create` with assets:
   ...
   - `update-manifest.json` (for in-app updater)
...
```json
{
  "versionCode": 3,
  "versionName": "1.0.1",
  "apkUrl": "https://github.com/thothassistantai-web/stepdaddy-gateway-android/releases/download/v1.0.1/app-release.apk",
