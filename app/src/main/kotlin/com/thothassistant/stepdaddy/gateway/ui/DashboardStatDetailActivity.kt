    ...
    private fun summarySources(
        ...
        return buildString {
            ...
            if (p != null) {
                ...
                appendLine("Dulo Live: ${numberFormat.format(p.duloCx)}")
        ...
        return when (type) {
            ...
            DashboardStatType.SOURCES -> buildString {
                health.supplement?.let { s ->
                    ...
                    appendLine("duloCxEnabled=${s.duloCxEnabled}")
                    appendLine("duloCxChannels=${s.duloCxChannels}")
                    appendLine("duloCxCatalogFetchOk=${s.duloCxCatalogFetchOk}")
                    appendLine("duloCxResolveProbeOk=${s.duloCxResolveProbeOk}")
                    appendLine("duloCxAuthConfigured=${s.duloCxAuthConfigured}")
