...
data class AdminSettingsSnapshot(
    ...
    val supplementXyzStreamsEnabled: Boolean,
    val supplementXyzStreamsEpgDiscoveryEnabled: Boolean,
...
data class AdminSettingsPatch(
    ...
    val supplementXyzStreamsEnabled: Boolean? = null,
    val supplementXyzStreamsEpgDiscoveryEnabled: Boolean? = null,
