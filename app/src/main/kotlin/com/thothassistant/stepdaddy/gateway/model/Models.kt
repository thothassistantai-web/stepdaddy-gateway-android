...
data class SupplementStatus(
    ...
    val iptvOrgImportMode: String = "CONSOLIDATE_FALLBACKS",
    val ntvCxImportMode: String = "CONSOLIDATE_FALLBACKS",
    /** @deprecated use [ntvCxImportMode] */
    val ntvCxMergeMode: String = "CONSOLIDATE_FALLBACKS",
    val ntvCxResolveProbeOk: Boolean = false,
    val adultSwimEnabled: Boolean = false,
    val adultSwimChannels: Int = 0,
    val adultSwimImportMode: String = "CONSOLIDATE_FALLBACKS",
    val freeTvEnabled: Boolean = false,
    val freeTvChannels: Int = 0,
    val freeTvImportMode: String = "CONSOLIDATE_FALLBACKS",
    val freeTvPlaylistsFetched: Int = 0,
    val freeTvPlaylistsFailed: Int = 0,
    val duloCxEnabled: Boolean = false,
    val duloCxChannels: Int = 0,
    val duloCxImportMode: String = "CONSOLIDATE_FALLBACKS",
    ...
    /** DaddyLive channels that have at least one consolidated supplement backup. */
    val daddyBackupChannels: Int = 0,
    /** Total supplement mirrors attached as DaddyLive backups. */
    val daddyBackupMirrors: Int = 0,
